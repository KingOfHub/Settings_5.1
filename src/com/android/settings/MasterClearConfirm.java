...
public class MasterClearConfirm extends Fragment {
    ...
    private Button.OnClickListener mFinalClickListener = new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            confirmDoMasterClear();
        }

    };
    private Button.OnClickListener mFinalShutdownClickListener = new Button.OnClickListener() {
    ...
    private void confirmDoMasterClear() {
    ...
    private void doMasterClear() {
        if (mEraseSdCard) {
            ...
            intent.putExtra("shutdown", mShutdown);
    ...
    private void establishFinalConfirmationState() {
        ...
        mContentView.findViewById(R.id.execute_master_clear_shutdown)
                .setOnClickListener(mFinalShutdownClickListener);
    }
