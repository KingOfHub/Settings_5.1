...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    private static final String KEY_VOICE = "voice_category";
    private static final String KEY_POINTER = "pointer_settings_category";
    ...
    private PreferenceCategory mPointerCategory;
    ...
    public void onCreate(Bundle icicle) {
        ...
        if( Build.PWV_CUSTOM_CUSTOM.equals("SYB")){
            ...
            mVoiceCategory= (PreferenceCategory)findPreference(KEY_VOICE);
            getPreferenceScreen().removePreference(mVoiceCategory);
            mPointerCategory= (PreferenceCategory)findPreference(KEY_POINTER);
            getPreferenceScreen().removePreference(mPointerCategory);
        }
        ...
        if( Build.PWV_CUSTOM_CUSTOM.equals("SYB")){
            getPreferenceScreen().removePreference(spellChecker);
            Preference mUserDictionary = findPreference(KEY_USER_DICTIONARY_SETTINGS);
            getPreferenceScreen().removePreference(mUserDictionary);
        }
    }
