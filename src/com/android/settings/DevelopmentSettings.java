...
public class DevelopmentSettings extends SettingsPreferenceFragment
    ...
    boolean isSigned = SystemProperties.getBoolean("pwv.custom.sign", false);
    ...
    public void onResume() {
        ...
        if( Build.PWV_CUSTOM_CUSTOM.equals("SYB") && Build.TYPE.equals("user") ) {
            if(getActivity().getIntent().getAction().equals("android.settings.APPLICATION_DEVELOPMENT_INTERNAL_SETTINGS") || !isSigned) {
                mSwitchBar.setChecked(mLastEnabledState);
                mSwitchBar.setEnabled(!Utils.isMonkeyRunning());
            } else {
    ...
    private void updateBugreportOptions() {
        if (Build.PWV_USER_MODE_FOR_DEBUGGING == true) {
