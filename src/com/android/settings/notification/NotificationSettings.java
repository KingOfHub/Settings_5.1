...
public class NotificationSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if( Build.PWV_CUSTOM_CUSTOM.equals("SYB")){
            sound.removePreference(sound.findPreference(KEY_ALARM_VOLUME));
            sound.removePreference(sound.findPreference(KEY_RING_VOLUME));
            sound.removePreference(sound.findPreference(KEY_VIBRATE_WHEN_RINGING));
            sound.removePreference(sound.findPreference(KEY_PHONE_RINGTONE));
            sound.removePreference(sound.findPreference(KEY_ZEN_MODE));
            sound.removePreference(sound.findPreference(KEY_NOTIFICATION_RINGTONE));
            getPreferenceScreen().removePreference(notification);
        }
    }
