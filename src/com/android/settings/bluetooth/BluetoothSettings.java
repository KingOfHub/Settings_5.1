 ...
 */
public final class BluetoothSettings extends DeviceListPreferenceFragment implements Indexable,Preference.OnPreferenceClickListener  {
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        if(mSimulatePrinterPreference != null && preference == mSimulatePrinterPreference) {
            ...
            btintent.setPackage("com.android.simulate.printer.server");
            if(enable) {
