...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private Preference mCastScreenPreference;
    private Preference mWallpaper;
    private Preference mBlurEffect;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.PROJECT.equals("SQ43T") || Build.PROJECT.equals("SQ27TC") || Build.PROJECT.equals("SQ27TE")) {
        ...
        } else if (RotationPolicy.isRotationLockToggleVisible(activity)) {
        ...
        if( Build.PWV_CUSTOM_CUSTOM.equals("SYB")){
            mBlurEffect = findPreference(KEY_BLUR_EFFECT);
            getPreferenceScreen().removePreference(mBlurEffect);
            mCastScreenPreference = findPreference(KEY_CAST_SCREEN);
            getPreferenceScreen().removePreference(mCastScreenPreference);
            mWallpaper = findPreference(KEY_WALLPAPER);
            getPreferenceScreen().removePreference(mWallpaper);
            mScreenSaverPreference = findPreference(KEY_SCREEN_SAVER);
            getPreferenceScreen().removePreference(mScreenSaverPreference);
        }
    }
